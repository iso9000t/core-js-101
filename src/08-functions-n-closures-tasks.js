...
function logger(func, logFunc) {
  return function loggingWrapper(...args) {
    ...
    const startLog = `${funcName}(${argsStr}) starts`;
    const endLog = `${funcName}(${argsStr}) ends`;
